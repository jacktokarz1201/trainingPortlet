...
/**
 * Provides the local service interface for course_assignment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author John
 * @see course_assignmentLocalServiceUtil
...
public interface course_assignmentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link course_assignmentLocalServiceUtil} to access the course_assignment local service. Add custom service methods to {@link com.ms3.training.services.service.impl.course_assignmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
