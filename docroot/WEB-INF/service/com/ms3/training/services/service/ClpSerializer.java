...
import com.ms3.training.services.model.AssignmentClp;
import com.ms3.training.services.model.CourseClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"training-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "training-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.ms3.training.services.model.impl.AssignmentImpl")) {
			return translateOutputAssignment(oldModel);
		}

		if (oldModelClassName.equals(
					"com.ms3.training.services.model.impl.CourseImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new com.ms3.training.services.NoSuchAssignmentException();
		}

		if (className.equals("com.ms3.training.services.NoSuchCourseException")) {
			return new com.ms3.training.services.NoSuchCourseException();
		}
